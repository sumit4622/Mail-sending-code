...
This code assumes the gmail library is installed and configured correctly.
It's crucial to replace the placeholder values for channel_id, read_api_key, and email credentials with your actual values.
Storing API keys and passwords directly in the code is generally not recommended for security reasons. Consider using environment variables or a secure configuration file.
